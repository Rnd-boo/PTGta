      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex justify-evenly">
          <div class="max-w-3xl pt-2">
            <img src="img/conveying.jpg" alt="Convey pic" class="w-full" />
          </div>
          <div class="mx-2 h-80 w-96 content-center rounded-b-xl bg-california p-2 text-white">
            <h1 class="-mt-6 mb-8 text-3xl font-semibold text-red-900">CONVEYING SYSTEM</h1>
        ...
        <div class="mx-auto mt-24 mb-6 text-black">
          <div class="flex my-1">
          ...
          <img src="img/bottle-convey.jpg" alt="" class="w-96 mb-2 rounded-b-xl" />
          <ul class="mx-1 flex list-inside list-disc justify-evenly marker:text-orange-500">
            <li class="text-xl mr-16">
              ...
              <div class="flex">
                <div>
                  <div class="aspect-square w-36 rounded-lg border-4 border-orange-600">
                    <img src="/img/glass-bottle.png" alt="Glass Bottle" class="p-2">
                  </div>
                  <h2 class="text-sm text-center text-hijau">GLASS BOTTLE</h2>
                </div>
                <div>
                  ...
                  <h2 class="text-sm text-center text-hijau">PET BOTTLE</h2>
                </div>
                <div>
                  <div class="aspect-square w-36 rounded-lg border-4 border-orange-600">
                    <img src="/img/aluminium-can.png" alt="Aluminium Can" class="mt-2">
                  </div>
                  <h2 class="text-sm text-center text-hijau">ALUMINIUM CAN</h2>
                </div>
              </div>
            </li>
          </ul>
        </div>
        <div class="mx-auto mt-16 mb-6 text-black">
          <div class="flex my-1">
            <svg aria-hidden="true" class="w-4 fill-orange-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-352a96 96 0 1 1 0 192 96 96 0 1 1 0-192z" /></svg>
            <h1 class="mx-1 text-xl font-semibold">BAG CONVEYING</h1>
          </div>
          <img src="img/bag-convey.jpg" alt="" class="w-96 mb-2 rounded-b-xl" />
          <ul class="mx-1 flex list-inside list-disc justify-evenly marker:text-orange-500">
            <li class="text-xl mr-16">
              <span class="font-medium"> Technical Advantages</span>
              <ul>
            ...
            <li>
              ...
              <div class="flex">
                ...
                <div>
                  ...
                  <h2 class="text-sm text-center text-hijau">AGRICULTURAL PRODUCTS</h2>
                </div>
              </div>
            </li>
          </ul>
        </div>
        <div class="mx-auto mt-16 text-black">
          <div class="flex my-1">
            <svg aria-hidden="true" class="w-4 fill-orange-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-352a96 96 0 1 1 0 192 96 96 0 1 1 0-192z" /></svg>
            <h1 class="mx-1 text-xl font-semibold">MODULE CONVEYING</h1>
          </div>
          <img src="img/module-convey.jpg" alt="" class="w-96 mb-2 rounded-b-xl" />
          <ul class="mx-1 flex list-inside list-disc justify-evenly marker:text-orange-500">
            <li class="text-xl mr-16">
              <span class="font-medium">Technical Advantages</span>
              <ul>
            ...
            <li>
              ...
              <div class="flex">
                <div>
                  <div class="aspect-square w-36 rounded-lg border-4 border-orange-600">
                    <img src="/img/metal.png" alt="" class="">
                  </div>
                  <h2 class="text-sm text-center text-hijau">METAL PARTS</h2>
                </div>
                <div>
                  <div class="mx-2 aspect-square w-36 rounded-lg border-4 border-orange-600"></div>
                  <h2 class="text-sm text-center text-hijau">BAGGED PRODUCT</h2>
                </div>
                <div>
                  <div class="aspect-square w-36 rounded-lg border-4 border-orange-600">
                    <img src="/img/medical.png" alt="Medical CAre" class="mt-4">
                  </div>
                  <h2 class="text-sm text-center text-hijau">MEDICAL CARE</h2>
                </div>
              </div>
            </li>
          </ul>
